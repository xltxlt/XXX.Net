...
namespace XXX.Net.Plugins.DingTalk.Utils
{
    public class DingtalkCrypto
    {
         ...
         */
        public DingtalkCrypto(String token= "DyMDIJpkuu6pNMTiPOen352A", String encodingAesKey= "SwTXTNlBxVrLp4IagU3HGgOKi1sDXfytL8Lw8whpXyQ", String corpId= "ding554fbc33827331f4bc961a6cb783455b")
        {
        ...
        public Dictionary<String, String> getEncryptedMap(String plaintext)
        {
            ...
            return getEncryptedMap(plaintext, (long)timeSpan.TotalMilliseconds);
        }
