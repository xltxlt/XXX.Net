...
**data** | [**Array&lt;PmFlowItem&gt;**](PmFlowItem.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListPmFlowItem } from './api';

const instance: RESTfulResultListPmFlowItem = {
    statusCode,
    data,
    succeeded,
    errors,
