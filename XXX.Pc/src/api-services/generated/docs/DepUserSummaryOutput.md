...
**children** | [**Array&lt;DepUserSummaryOutput&gt;**](DepUserSummaryOutput.md) |  | [optional] [default to undefined]

## Example

```typescript
import { DepUserSummaryOutput } from './api';

const instance: DepUserSummaryOutput = {
    id,
    parentId,
    name,
    code,
