...
**data** | [**Array&lt;SysTenantDto&gt;**](SysTenantDto.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListSysTenantDto } from './api';

const instance: RESTfulResultListSysTenantDto = {
    statusCode,
    data,
    succeeded,
    errors,
