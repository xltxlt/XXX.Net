...
|[**apiWorkflowDefinitionTempPublishStatusTemplateidGet**](#apiworkflowdefinitiontemppublishstatustemplateidget) | **GET** /api/workflow-definition/temp-publish-status/{templateid} | |
...
# **apiWorkflowDefinitionTempPublishStatusTemplateidGet**
> RESTfulResultTempPublishStatusOutput apiWorkflowDefinitionTempPublishStatusTemplateidGet()
...
const { status, data } = await apiInstance.apiWorkflowDefinitionTempPublishStatusTemplateidGet(
    templateid
);
```
...
**RESTfulResultTempPublishStatusOutput**
