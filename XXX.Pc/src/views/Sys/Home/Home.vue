    ...
    <section class="content-grid">
      <div class="panel todo-panel">
        <div class="panel-header">
          ...
          <button class="more-button" @click="openTodo()">全部待办
            <ArrowRight />
          </button>
        </div>
      ...
      <div class="panel notice-panel">
        <div class="panel-header">
          ...
          <button class="more-button" @click="openNotices">全部通知
            <ArrowRight />
          </button>
        </div>

        <div class="notice-list">
          <button v-for="item in notices" :key="item.id" class="notice-row" @click="markNoticeRead(item)">
...
.summary-card:hover {
  ...
  box-shadow: 0 9px 24px rgba(26, 62, 97, .09);
  border-color: #d5e4f3;
}
...
.quick-links button:nth-child(2)>svg {
  color: #21ae84;
  background: #eafaf5;
}

.quick-links button:nth-child(3)>svg {
  color: #6b70e8;
  background: #f0f1ff;
}

.quick-links button:nth-child(4)>svg {
  color: #ee9a2c;
  background: #fff4e5;
}
